...
import { voucherCreateController } from 'src/features/voucher/controllers/voucherCreateController';
...
describe('voucherCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await voucherCreateController(body, await testContext());
      fail();
    } catch (error) {
