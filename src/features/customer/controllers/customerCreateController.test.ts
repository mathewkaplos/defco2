...
async function buildCustomer(context: AppContext) {
...
describe('customerCreate', () => {
  ...
  it('must be signed in', async () => {
    const body = await buildCustomer({
      currentTenant,
      currentUser,
    ...
    try {
      await customerCreateController(body, await testContext());
      fail();
    } catch (error) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await customerCreateController(
        body,
        await testContext({
