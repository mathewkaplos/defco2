...
import { saleImporterController } from 'src/features/sale/controllers/saleImporterController';
...
describe('saleImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await saleImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it.skip('imports', async () => {
    ...
    const response = await saleImporterController(
