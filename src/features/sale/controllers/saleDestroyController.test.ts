...
import { saleDestroyManyController } from 'src/features/sale/controllers/saleDestroyManyController';
...
describe('saleDestroy', () => {
  ...
  it('must be signed in', async () => {
    try {
      await saleDestroyManyController(
        {
          ids: [sale?.id],
        },
        await testContext(),
  ...
  it.skip('deletes', async () => {
    const countBeforeDelete = await prisma.sale.count();
    ...
    const countAfterDelete = await prisma.sale.count();
