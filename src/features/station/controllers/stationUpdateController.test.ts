...
import { stationUpdateController } from 'src/features/station/controllers/stationUpdateController';
...
describe('stationUpdate', () => {
  ...
  //     const previousStation = await createStation(
  //       await testContext({
  //         currentUserId: currentUser?.id,
  //         currentTenantId: currentTenant?.id,
  //       }),
  ...
  //     const updatedStation = await prisma.station.findUniqueOrThrow({
  //       where: { id: previousStation?.id },
  //       include: {},
  //     });
