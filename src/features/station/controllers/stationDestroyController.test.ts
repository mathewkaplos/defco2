...
import { stationDestroyManyController } from 'src/features/station/controllers/stationDestroyManyController';
...
describe('stationDestroy', () => {
  ...
  it('must be signed in', async () => {
    try {
      await stationDestroyManyController(
        {
          ids: [station?.id],
        },
        await testContext(),
  ...
  it.skip('deletes', async () => {
    const countBeforeDelete = await prisma.station.count();
    ...
    const countAfterDelete = await prisma.station.count();
