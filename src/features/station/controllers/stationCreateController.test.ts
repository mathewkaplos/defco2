...
import { stationCreateController } from 'src/features/station/controllers/stationCreateController';
...
describe('stationCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await stationCreateController(body, await testContext());
      fail();
    } catch (error) {
