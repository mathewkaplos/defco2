...
import { productImporterController } from 'src/features/product/controllers/productImporterController';
...
async function buildProduct(context: AppContext) {
...
describe('productImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await productImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await productImporterController(
        body,
        await testContext({
          currentUserId: currentUser?.id,
          currentTenantId: currentTenant?.id,
  ...
  it.skip('imports', async () => {
    ...
    const response = await productImporterController(
