...
describe('dispenserUpdate', () => {
  ...
  it.skip('must be signed in', async () => {
    const dispenser = await createDispenser(
      await testContext({
    ...
    try {
      await dispenserUpdateController(
        { id: dispenser.id },
        {},
        await testContext(),
      );
  ...
  //     const previousDispenser = await createDispenser(
  //       await testContext({
  //         currentUserId: currentUser?.id,
  //         currentTenantId: currentTenant?.id,
  //       }),
  ...
  //     const updatedDispenser = await prisma.dispenser.findUniqueOrThrow({
  //       where: { id: previousDispenser?.id },
  //       include: {},
  //     });
