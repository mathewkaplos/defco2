...
async function buildCard(context: AppContext) {
...
describe('cardImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await cardImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it.skip('imports', async () => {
    ...
    const response = await cardImporterController(
