...
import { materialReceiptDestroyManyController } from 'src/features/materialReceipt/controllers/materialReceiptDestroyManyController';
...
describe('materialReceiptDestroy', () => {
  ...
  it('must be signed in', async () => {
    try {
      await materialReceiptDestroyManyController(
        {
          ids: [materialReceipt?.id],
        },
        await testContext(),
      );
      fail();
  ...
  it.skip('deletes', async () => {
    const countBeforeDelete = await prisma.materialReceipt.count();
    ...
    const countAfterDelete = await prisma.materialReceipt.count();
