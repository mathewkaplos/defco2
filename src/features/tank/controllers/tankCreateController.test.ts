...
import { tankCreateController } from 'src/features/tank/controllers/tankCreateController';
...
describe('tankCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await tankCreateController(body, await testContext());
      fail();
    } catch (error) {
