...
describe('vehicleDestroy', () => {
  ...
  it('must be signed in', async () => {
    try {
      await vehicleDestroyManyController(
        {
          ids: [vehicle?.id],
        },
        await testContext(),
  ...
  it.skip('deletes', async () => {
    const countBeforeDelete = await prisma.vehicle.count();
    ...
    const countAfterDelete = await prisma.vehicle.count();
