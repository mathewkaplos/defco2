...
import { vehicleImporterController } from 'src/features/vehicle/controllers/vehicleImporterController';
...
async function buildVehicle(context: AppContext) {
...
describe('vehicleImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await vehicleImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await vehicleImporterController(
        body,
        await testContext({
          currentUserId: currentUser?.id,
          currentTenantId: currentTenant?.id,
  ...
  it.skip('imports', async () => {
    ...
    const response = await vehicleImporterController(
