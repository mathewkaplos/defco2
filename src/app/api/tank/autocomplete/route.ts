...
import { tankAutocompleteController } from 'src/features/tank/controllers/tankAutocompleteController';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await tankAutocompleteController(query, context);
