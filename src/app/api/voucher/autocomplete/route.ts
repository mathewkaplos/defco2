...
import { voucherAutocompleteController } from 'src/features/voucher/controllers/voucherAutocompleteController';
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await voucherAutocompleteController(query, context);
