...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const payload = await saleCreateController(body, context);
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const payload = await saleFindManyController(query, context);
    return NextResponseSuccess(request, context, payload);
  } catch (error: any) {
    return NextResponseError(request, context, error);
  }
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    context = await appContext(request);
    const query = queryToObject(request.nextUrl.search);
    await saleDestroyManyController(query, context);
    const payload = true;
    return NextResponseSuccess(request, context, payload);
  } catch (error: any) {
    return NextResponseError(request, context, error);
